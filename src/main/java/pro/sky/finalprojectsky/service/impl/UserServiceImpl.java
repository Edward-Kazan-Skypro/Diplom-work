...
public class UserServiceImpl implements UserService {
    ...
    public UserDto getUserById(long id) {
        ...
        return userMapper.toDto(userRepository.findById((int) id)
    ...
    public UserDto updateRole(long id, Role role) {
        ...
        User user = userRepository.findById((int) id).orElseThrow(() -> new NotFoundException("Пользователь с id " + id + " не найден!"));
        user.setRole(role);
        userRepository.save(user);
        return userMapper.toDto(user);
    }
